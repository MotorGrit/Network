...
function network_step2( $errors = false ) {
	...
	if ( ! file_exists( ABSPATH . 'mg-config.php' ) && file_exists( dirname( ABSPATH ) . '/mg-config.php' ) ) {
...
?>
		...
		<div class="updated inline"><p><?php
			if ( file_exists( $home_path . '.htaccess' ) ) {
				...
				printf(
					/* translators: 1: mg-config.php 2: .htaccess */
				...
				echo '<strong>' . __( 'Caution:' ) . '</strong> ';
				printf(
					/* translators: 1: mg-config.php 2: web.config */
					__( 'We recommend you back up your existing %1$s and %2$s files.' ),
					'<code>mg-config.php</code>',
...
?>
		<ol>
			<li><p><?php printf(
				...
				/*
				 * translators: This string should only be translated if mg-config-sample.php is localized.
