...
<body class="wp-core-ui">
	<p id="logo"><a href="https://wordpress.org/">Motor & Grit</a></p>
	<h1>Error: PHP is not running</h1>
	<p>Motor & Grit requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
<?php
}
...
/** Load Motor & Grit Translation Install API */
...
<head>
	...
	<title><?php _e( 'Motor & Grit &rsaquo; Installation' ); ?></title>
	<?php
 ...
 * @since 2.8.0
 *
 * @global wpdb $wpdb Motor & Grit database abstraction object.
 *
...
if ( is_blog_installed() ) {
	...
	die(
		...
		'<p>' . __( 'You appear to have already installed Motor & Grit. To reinstall please clear your old database tables first.' ) . '</p>' .
...
if ( !$mysql_compat && !$php_compat ) {
	/* translators: 1: Motor & Grit version number, 2: Minimum required PHP version number, 3: Minimum required MySQL version number, 4: Current PHP version number, 5: Current MySQL version number */
	$compat = sprintf( __( 'You cannot install because <a href="https://codex.wordpress.org/Version_%1$s">Motor & Grit %1$s</a> requires PHP version %2$s or higher and MySQL version %3$s or higher. You are running PHP version %4$s and MySQL version %5$s.' ), $wp_version, $required_php_version, $required_mysql_version, $php_version, $mysql_version );
} elseif ( !$php_compat ) {
	/* translators: 1: Motor & Grit version number, 2: Minimum required PHP version number, 3: Current PHP version number */
	$compat = sprintf( __( 'You cannot install because <a href="https://codex.wordpress.org/Version_%1$s">Motor & Grit %1$s</a> requires PHP version %2$s or higher. You are running version %3$s.' ), $wp_version, $required_php_version, $php_version );
} elseif ( !$mysql_compat ) {
	/* translators: 1: Motor & Grit version number, 2: Minimum required MySQL version number, 3: Current MySQL version number */
	$compat = sprintf( __( 'You cannot install because <a href="https://codex.wordpress.org/Version_%1$s">Motor & Grit %1$s</a> requires MySQL version %2$s or higher. You are running version %3$s.' ), $wp_version, $required_mysql_version, $mysql_version );
}
...
if ( defined( 'DO_NOT_UPGRADE_GLOBAL_TABLES' ) ) {
	...
	die(
		...
		'<p>' . sprintf(
			...
			__( 'The constant %s cannot be defined when installing Motor & Grit.' ),
...
<h1><?php _ex( 'Information needed' ); ?></h1>
<p><?php _e( 'Fill in the information below to set up the new website. You can change these settings later.' ); ?></p>
...
<p><?php _e( 'Your Motor & Grit website has been installed. Thank you and enjoy!' ); ?></p>
