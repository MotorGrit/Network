...
<body <?php body_class(); ?>>
<?php MG_Theme\Tags\before_page(); ?>
<div id="page" class="site" itemscope="itemscope" itemtype="<?php MG_Theme\Tags\site_schema(); ?>">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'mg-theme' ); ?></a>
				...
				<figure>
					...
					if ( has_header_image() ) {
						...
						echo sprintf(
							...
							get_bloginfo( 'name' ) . __( 'header image', 'mg-theme' )
						);
					} ?>
				</figure>
			</div>
