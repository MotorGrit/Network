...
function wp_clear_auth_cookie() {
	...
	// Settings cookies
	setcookie( 'app-settings-' . get_current_user_id(),      ' ', time() - YEAR_IN_SECONDS, SITECOOKIEPATH );
	setcookie( 'app-settings-time-' . get_current_user_id(), ' ', time() - YEAR_IN_SECONDS, SITECOOKIEPATH );
