...
/*
 * If mg-config.php exists in the WordPress root, or if it exists in the root and wp-settings.php
 * doesn't, load mg-config.php. The secondary check for wp-settings.php has the added benefit
...
if ( file_exists( ABSPATH . 'mg-config.php') ) {
	...
	$die .= '<p>' . sprintf(
		...
		__( 'https://codex.wordpress.org/Editing_mg-config.php' )
	) . '</p>';
	$die .= '<p>' . sprintf(
		/* translators: %s: mg-config.php */
